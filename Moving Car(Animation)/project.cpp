...
void InitGL(int Width, int Height)         
{
  ...
  glClearColor(0.5294f, 0.80784f, 0.9765f, 0.0f);    
...
void ReSizeGLScene(int Width, int Height)
{
  ...
  glViewport(0, -1, Width, Height);        // Reset The Current Viewport And Perspective Transformation
...
void drawBall(void) {
        ...
        glTranslatef(ballX+2.0,ballY,ballZ); //moving it toward the screen a bit on creation
...
void DrawGLScene()
{
  ...
  glTranslatef(rtri,-1.0f,-4.0f);        // Move Left 1.5 Units And Into The Screen 6.0
  // -5.0f size of car
...
glVertex3f(-1.5f, 0.4f, 0.0f);
  ...
  glVertex3f(0.4f, 1.0f, 0.0f);			// top right
  
  glVertex3f(1.0f, 0.4f, 0.0f);			// Front
  glVertex3f(1.5f, 0.4f, 0.0f);			// front
...
*/
  ...
  glColor3f(0.5019f,0.5019f,0.5019f);
  ...
  if(rtri>2)
      rtri=-2.0f;
  rquad-=20.0f;                    // Decrease The Rotation Variable For The Quad
