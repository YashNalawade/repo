...
public class WeatherFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        updateWeatherData(new com.example.yash.demomaps.CityPreference(getActivity()).getCity());
    }
    ...
    public void updateWeatherData(final String city) {
        new Thread() {
            @Override
            public void run() {
                final JSONObject json = com.example.yash.demomaps.RemoteFetch.getJSON(getActivity(), city);
                if(json == null) {
    ...
    private void renderWeather(JSONObject json) {
        try {
            ...
            MapsActivity.tv1.setText("   "+Character.toUpperCase(cityname.charAt(0)) + cityname.substring(1)+"  "+String.format("%.2f", main.getDouble("temp")) + " °C");
